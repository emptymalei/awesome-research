...
* [Wordpress](http://wordpress.org/) (PHP): require a lot of maintance.
* [Pico](https://github.com/gilbitron/Pico): lightweight cms, open source, no database.
* [Ghost](https://github.com/tryghost/Ghost) (Node.js): Open, Simple, non-profit; write with markdown and live preview.
* [Dropplets](https://github.com/circa75/dropplets):Open source, simple, and elegant blog system; write in Markdown.
